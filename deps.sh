...
if [ $distro = "Kali" ]
then
    APT_CANDIDATES="git build-essential python3-opengl mtd-utils gzip bzip2 tar arj lhasa p7zip p7zip-full cabextract util-linux firmware-mod-kit cramfsswap squashfs-tools zlib1g-dev liblzma-dev liblzo2-dev sleuthkit default-jdk lzop cpio"
...
PYTHON3_APT_CANDIDATES="python3-crypto python3-pip python3-tk python3-lzo python3-setuptools"
